...
class Order extends CI_Controller
{
    ...
    public function index()
    {
        ...
        display('default/member/order/index.html');
    }
    ...
    public function view($id)
    {
        ...
        display('default/member/order/view.html');
    }
    ...
    {
        assign('order_id', $id);
        display('default/member/order/delivery_status.html');
    }
    ...
    public function comment($id)
    {
        ...
        if (is_comment($order_data)) {
            ...
            assign('order_data', $order_data);
            assign('order_sku', $order_sku);
            display('default/member/order/comment.html');
    ...
    public function refund($id)
    {
        ...
        if ($order_sku_data['is_refund'] == 1 || $order_sku_data['is_refund'] == 2) {
            ...
            //展示退款详情
            display('default/member/order/refund_view.html');
        } else {
            if (is_refund($order_data)) {
                //添加退款申请
                display('default/member/order/refund_add.html');
            } else {
                msg('已经确认和未支付的不能退款');
            }
