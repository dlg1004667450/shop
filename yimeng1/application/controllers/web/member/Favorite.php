...
class Favorite extends CI_Controller
{
    ...
    public function goods()
    {
        ...
        //搜索条件end
        $where_data['select']          = 'g.id as goods_id,g.name,g.image,g.sell_price,f.id';
        ...
        //开始分页end
        display('default/member/favorite/goods.html');
    }
    ...
    public function shop()
    {
        ...
        assign('list', $list);
        display('default/member/favorite/shop.html');
    }
