...
class Goods extends CI_Controller
{
    ...
    public function goods_list()
    {
        ...
        display('default/goods/goods_list.html');
    }
    ...
    public function product($id)
    {
        ...
        if (!empty($id)) {
            ...
            if ($visit && strpos($visit, $goods_visit) !== false) {
                ...
                $this->loop_model->update_id('goods', array('set' => array('visit', 'visit+1')), $id);
        ...
        display('default/goods/product.html');
    }
    ...
    public function comment($id)
    {
        ...
        assign('goods_data', $goods_data);
        display('default/goods/comment.html');
    }
    ...
    public function join_cart_product($id)
    {
        ...
        assign('goods_data', $goods_data);
        display('default/goods/join_cart_product.html');
    }
}
