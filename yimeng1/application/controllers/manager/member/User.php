...
class User extends CI_Controller
{
    ...
    public function index()
    {
        ...
        display('manager/member/user/list.html');
    }
    ...
    public function edit($id = '')
    {
        ...
        $user_group_list = $this->loop_model->get_list('member_user_group');
        assign('user_group_list', $user_group_list);
        display('manager/member/user/add.html');
    }
    ...
    public function account_log($m_id = '')
    {
        ...
        display('manager/member/user/account_log.html');
    }
    ...
    public function point_log($m_id = '')
    {
        ...
        display('manager/member/user/point_log.html');
    }
}
