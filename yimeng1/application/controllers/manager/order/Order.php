...
class Order extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (empty($export)) {
            ...
            display('manager/order/order/list.html');
        } else {
    ...
    public function edit($id = '')
    {
        ...
        if (!empty($id)) {
            ...
            assign('item', $item);
            display('manager/order/order/add.html');
        }
    }
    ...
    public function view($id = '')
    {
        ...
        if (!empty($id)) {
            ...
            display('manager/order/order/view.html');
        }
    }
    ...
    public function order_send($id)
    {
        ...
        if (!empty($id)) {
            ...
            if (is_send($order_data)) {
                ...
                display('manager/order/order/send.html');
            } else {
                echo '不满足发货条件';
            }
        }
    ...
    public function refund($id)
    {
        ...
        if (!empty($id)) {
            ...
            if (is_refund($order_data)) {
                ...
                assign('sku_list', $sku_list);
                display('manager/order/order/refund.html');
            } else {
                echo '不满足退款条件';
            }
        }
    ...
    public function print_express_select()
    {
        ...
        if (!empty($order_id)) {
            ...
            display('manager/order/order/print_express_select.html');
        } else {
            echo '订单号错误';
        }
    }
    ...
    public function print_express()
    {
        ...
        display('manager/order/order/print_express.html');
    }
    ...
    public function print_distribution()
    {
        ...
        display('manager/order/order/print_distribution.html');
    }
}
