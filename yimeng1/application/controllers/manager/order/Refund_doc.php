...
class Refund_doc extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (empty($export)) {
            ...
            display('manager/order/refund_doc/list.html');
        } else {
    ...
    public function pending()
    {
        ...
        display('manager/order/refund_doc/pending.html');
    }
    ...
    public function refund_doc_view($id)
    {
        ...
        if (!empty($id)) {
            ...
            if ($order_refund_doc_data['status'] == 0) {
                ...
                display('manager/order/refund_doc/refund_doc_view.html');
            } else {
                echo "退款申请已经处理";
            }
        }
    ...
    public function refund_doc_log($id)
    {
        ...
        if (!empty($id)) {
            ...
            display('manager/order/refund_doc/refund_doc_log.html');
        }
    }
}
