...
class Statistics extends CI_Controller
{
    ...
    public function user_reg()
    {
        ...
        if ($export == 1) {
            ...
            display('manager/report/statistics/user_reg.html');
        }
    }
    ...
    public function consumption_avg()
    {
        ...
        if ($export == 1) {
            ...
            assign('list', array('categories' => $categories, 'value' => $value));
            display('manager/report/statistics/consumption_avg.html');
        }
    }
    ...
    public function consumption_sum()
    {
        ...
        if ($export == 1) {
            ...
            assign('list', array('categories' => $categories, 'value' => $value));
            display('manager/report/statistics/consumption_sum.html');
        }
    }
    ...
    public function order_count()
    {
        ...
        if ($export == 1) {
            ...
            assign('list', array('categories' => $categories, 'value' => $value));
            display('manager/report/statistics/order_count.html');
        }
    }
