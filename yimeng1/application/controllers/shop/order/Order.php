...
class Order extends CI_Controller
{
    ...
    public function index()
    {
        ...
        display('shop/order/order/list.html');
    }
    ...
    public function edit($id = '')
    {
        ...
        if (!empty($id)) {
            ...
            assign('item', $item);
            display('shop/order/order/add.html');
        }
    }
    ...
    public function view($id = '')
    {
        ...
        if (!empty($id)) {
            ...
            display('shop/order/order/view.html');
        }
    }
    ...
    public function order_send($id)
    {
        ...
        if (!empty($id)) {
            ...
            if (is_send($order_data)) {
                ...
                display('shop/order/order/send.html');
            } else {
                echo '不满足发货条件';
            }
        }
    ...
    public function refund($id)
    {
        ...
        if (!empty($id)) {
            ...
            if (is_refund($order_data)) {
                ...
                assign('sku_list', $sku_list);
                display('shop/order/order/refund.html');
            } else {
                echo '不满足退款条件';
            }
        }
    ...
    public function print_express_select()
    {
        ...
        if (!empty($order_id)) {
            ...
            display('shop/order/order/print_express_select.html');
        } else {
            echo '订单号错误';
        }
    }
    ...
    public function print_express()
    {
        ...
        display('shop/order/order/print_express.html');
    }
    ...
    public function print_distribution()
    {
        ...
        display('shop/order/order/print_distribution.html');
    }
}
