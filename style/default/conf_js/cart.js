...
function sum_order_price() {
    ...
    //计算每个店铺内的总金额
    $('[class="billbox"]').each(function () {
        var shop_sell_price = delivery_price = coupons_amount = shop_all_price = 0;
        //商品价格
        ...
        //优惠券价格
        coupons_amount = parseFloat($(this).find('[data-coupons_amount="coupons_amount"]:checked').attr('couponsamount'));
        //优惠活动价格
        promotion_price = parseFloat($(this).find('[name="promotion_price[]"]').val());
        //总价
